# ![LOGO](logo.png) AWS Secrets Manager MSP Connector

## Description

A generated MSP connector for the AWS Secrets Manager API (version 2017-10-17).
...
flowground :- Telekom iPaaS / amazonaws-com-secretsmanager-connector<br/>
